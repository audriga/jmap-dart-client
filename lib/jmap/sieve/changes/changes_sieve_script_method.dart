...
part 'changes_sieve_script_method.g.dart';

@UnsignedIntNullableConverter()
@StateConverter()
@AccountIdConverter()
@JsonSerializable()
class ChangesSieveScriptMethod extends ChangesMethod {
  ...
  @override
  MethodName get methodName => MethodName('SieveScript/changes');
  ...
  factory ChangesSieveScriptMethod.fromJson(Map<String, dynamic> json) =>
      _$ChangesSieveScriptMethodFromJson(json);

  @override
  Map<String, dynamic> toJson() => _$ChangesSieveScriptMethodToJson(this);
}
